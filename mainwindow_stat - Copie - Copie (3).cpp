#include "mainwindow_stat.h"
#include "pieview.h"
#include <QtWidgets>

MainWindow_stat::MainWindow_stat()
{
    ...
    connect(openAction, &QAction::triggered, this, &MainWindow_stat::openFile);
    connect(saveAction, &QAction::triggered, this, &MainWindow_stat::saveFile);
